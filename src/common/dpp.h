...
#define DPP_PRESENCE_ANNOUNCE_NUM_PREFERRED_FREQ 3
#define DPP_PRESENCE_ANNOUNCE_MAX_TARGETED_FREQ 30
#define DPP_PRESENCE_ANNOUNCE_MAX_FREQ \
	( DPP_PRESENCE_ANNOUNCE_NUM_PREFERRED_FREQ \
	+ DPP_PRESENCE_ANNOUNCE_MAX_TARGETED_FREQ \
